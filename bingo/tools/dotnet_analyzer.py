...
<head>
    <meta charset="UTF-8">
    <title>CSWSH PoC — bingo v2.3.1</title>
    <style>
...
<body>
    ...
    <script>
    // bingo v2.3.1 — Auto-generated CSWSH PoC
...
def generate_powershell_dump(exe_path: str) -> str:
    ...
    """
    return f"""# bingo v2.3.1 — .NET String Dump via PowerShell Reflection
...
def format_report(result: DotNetAnalysisResult) -> str:
    ...
    lines = [
        "",
        "═" * 60,
        f"  bingo v2.3.1 — .NET Analysis Report",
