...
_STRINGS.update({
    ...
    "rule_26ae_chmod":              {"ko": "⚠ [RULE 26-AE] chmod/apt-get/apt install 금지 — Windows 비호환 명령",
                                     "zh": "⚠ [RULE 26-AE] 禁止使用 chmod/apt-get/apt install — Windows 不兼容命令",
                                     "en": "⚠ [RULE 26-AE] chmod/apt-get/apt install forbidden — Windows incompatible commands"},
